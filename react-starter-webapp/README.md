# React Webapp Starter for Dataiku

A starter template for building modern webapps that deploy to Dataiku. Uses React + Vite for the frontend and Python (FastAPI/Flask) backend.
